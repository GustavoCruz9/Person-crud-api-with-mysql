package cruz.gustavo.unittests.mockito.services;
...
import cruz.gustavo.unittests.mapper.mocks.MockPerson;
...
class PersonServicesTest {
	...
	void testFindById() {
		...
		when(pRep.findById(1L)).thenReturn(Optional.of(entity));
	...
	void testUpdate() {
		...
		when(pRep.findById(1L)).thenReturn(Optional.of(entity));
		when(pRep.save(entity)).thenReturn(persisted);
	...
	void testFindAll() {
		...
		when(pRep.findAll()).thenReturn(list);
